...
try:
    ...
    logger.info(f"{e}: Gooey GUI builder not available, "
                   ...
                   f"Install with 'pip install Gooey if you want az no-arg GUI to invoke v2e'. See README")
...
def main():
    ...
    print("tyf get_args args", args)
    print("tyf get_args other_args", other_args)
    print("tyf get_args command_line", command_line)


    # set input file
    input_file = args.input
    synthetic_input:str = args.synthetic_input
    print("tyf synthetic_input", synthetic_input)
    ...
    output_folder = set_output_folder(
        ...
        logger)
    print("tyf output_folder", output_folder)
    ...
    output_width, output_height = set_output_dimension(
        ...
        logger)
    print("tyf output_width, output_height", output_width, output_height)
   ...
   # input file checking
    ...
    if synthetic_input is None:
        ...
        if cap is not None:
            ...
            set_size = False
            print("tyf output_height", output_height, hasattr(cap,'frame_height'))
        ...
        print("tyf srcNumFrames srcFps",srcNumFrames, srcFps)
        ...
        print("tyf input_slowmotion_factor srcFrameIntervalS",input_slowmotion_factor, srcFrameIntervalS)
            ...
            with TemporaryDirectory() as interpFramesFolder:
                ...
                if slomo is not None and (auto_timestamp_resolution or slowdown_factor != NO_SLOWDOWN):
                    ...
                    logger.info(
                        ...
                        .format(srcFrameIntervalS, avgUpsamplingFactor, eng(avgTs)))
